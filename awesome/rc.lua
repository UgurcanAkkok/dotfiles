...
local mybat = require("widgets/battery")
local mywifi = require("widgets/wifi")
local mydate = require("widgets/date")
...
awesome.connect_signal("startup", function () 
     -- awful.spawn.easy_async_with_shell("initwm")
    awful.spawn.easy_async_with_shell("picom")
    awful.spawn.easy_async_with_shell("xbindkeys")
    awful.spawn.easy_async_with_shell('amixer sset "Mic Mute-LED Mode" "Follow Capture"')
    awful.spawn.easy_async_with_shell('xinput set-prop "DELL0818:00 044E:121F Mouse" "libinput Scroll Method Enabled" 0 0 1')
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "x", function() awful.spawn.with_shell(media_cmd["toggle"]) end,
              {description = "media pause/resume", group = "launcher"}),

    awful.key({ modkey }, "c", function() awful.spawn.with_shell(media_cmd["next"]) end,
              {description = "media next", group = "launcher"}),

    awful.key({ modkey }, "z", function() awful.spawn.with_shell(media_cmd["prev"]) end,
    ...
    awful.key({ modkey }, "Print", function() awful.spawn("fish -c screenshot") end,
              {description = "Take a screenshot", group = "launcher"}),
    awful.key({ modkey, "Control" }, "s", function() awful.spawn.with_shell("slock") end,
              {description = "Lock the system", group = "launcher"}),
    awful.key({ modkey }, "b",
          function ()
